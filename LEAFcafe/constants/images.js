...
const coffee_img = require("../assets/images/coffee.jpg");
const latte_1 = require("../assets/images/latte_1.jpg");
const latte_2 = require("../assets/images/latte_2.jpg");
const latte_3 = require("../assets/images/latte_3.jpg");
const cappuccino_img = require("../assets/images/cappuccino_img.jpg");
const cappuccino_1 = require("../assets/images/cappuccino_1.jpg");
const cappuccino_2 = require("../assets/images/cappuccino_2.jpg");
const cappuccino_3 = require("../assets/images/cappuccino_3.jpg");
const watermelon_img = require("../assets/images/watermelon_img.jpg");
const watermelon_1 = require("../assets/images/watermelon_1.jpg");
const watermelon_2 = require("../assets/images/watermelon_2.jpg");
